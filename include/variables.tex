...
\newcommand{\Literature}{%
    \en{Management and Leadership Theoretical Background}%
    \hu{A vezetés és kompetenciák elméleti háttere}%
}
\newcommand{\ManagementExperience}{%
    \en{Own Leadership Experience and Introduction}%
    \hu{Saját vezetői tapasztalat és bemutatkozás}%
}
\newcommand{\Introspection}{%
    \en{Self Assessment Test with the Competence Analysis}%
    \hu{Egyéni kompetenciaelemzés az önértékelő teszt alapján}%
}
\newcommand{\DevelopementPlan}{%
    \en{Development Plan}%
    \hu{Fejlesztési terv}%
}
